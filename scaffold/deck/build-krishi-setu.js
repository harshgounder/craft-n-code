...
stats.forEach((st, i) => {
  const x = M + i * (CW + 0.35);
  card(s, x, 2.45, CW, 1.6, DARK, { rotate: -2, strip: "3E5C42" });
...
// ---------- S2B RESEARCH MACHINE (the depth proof) ----------
{
  ...
  cards.forEach((c, i) => {
    ...
    s.addText("source: EVIDENCE-INDEX.md · freshness: 2026-08-15", { x: x + 0.2, y: y + 1.05, w: 4.05, h: 0.16, fontSize: 7.5, color: "8FAE8B", fontFace: "Arial", margin: 0 });
  });
