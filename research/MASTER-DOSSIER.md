...
## 1. WHO RUNS IT (full lineage)

### National: Tech Society, IIIT Bhubaneswar (Unstop org 11832)
- Flagship hackathon under **D³ Fest** (Dream • Dare • Develop), the annual techno-management fest.
- D³ Fest 2025: Tech Society + TARS (Automation & Robotics Society), 3,000+ participants, ₹131K pool.
- D³ Fest 2026 site: d3fest.techsoc-iiitbbsr.com (Next.js, "COMING SOON" shell).
- Socials: LinkedIn /company/tech-society-iiitbh, IG @techsociiitbh (741 followers), FB tesoc.iiitbh.
- Sibling events: Hackfest (national, 3-round), Hackfest-Advaita (GDG on Campus), Advaita'24.

### Rajasthan: Cyber Space Club (CSC) MUJ
- Site: cscmuj.com (also csc-24.vercel.app for 2024-25), IG @csc_muj (685 followers), LinkedIn /company/cyber-space-club.
- **2026-27 exec committee** (VERIFIED from cscmuj.com/team):
  - Chairperson: Abhinav Trikha | Vice-Chair: Ambika Seth | Gen Sec: Shiv Pratap Suryavanshi | Treasurer: Stuti Agrawal | Tech Sec: Harshit Raj Singh | MD: Suyash Pandey | Creative Dir: Amritansh Srivastava | Joint Sec: Avichal Khanna | Art Dir: Soumyadeepa Pal
  - Faculty coordinators: Dr. Roheet Bhatnagar, Dr. Umashankar Rawat, Dr. Amit Kumar Bairwa, Dr. Sanchit Anand
  - Advisory: Rishabh Pandey, Kuber Chhabra, Ganesh Kotwade, Arnab Roy, Pranav Upadhyay, Aditya Agrawal, Anhadbani Anand
  - 10 heads + 19 joint heads + 18 senior coordinators (full list in PEOPLE-DOSSIER-CSC.md)
- **2024-25**: Srivatsa Palepu (Chair), Chitransh Saxena (Vice-Chair).
...
| Edition | Name | Structure | Prizes | Scale (Unstop API) |
|---|---|---|---|---|
| 2024 | CraftNCode | State prelims (₹200/team) → 24h finals at IIIT-B (Nov 8) | ₹30K/₹20K/goodies | National 1171379: 1318 reg/280 players; State 1175823: 24 reg/2 players |
| 2025 | Rewind & Recode | State rounds → nationals Nov 7-9 | ₹50K/state listing | RJ 706/147, PB 58/9, BR 15/1, TN 182/20 |
| 2026 | Craft N Code | State rounds → nationals Oct 30-Nov 1 | ₹50K winner | UP 1730325: 1 reg (fresh) |

### 2024 rules (VERIFIED, Unstop API 1171379)
- ₹200/team, 2-4 members (cross-college same state OK), 24h finals at IIIT-B.
- Original work only (pre-built = DQ), **GitHub push every 3 hours**, submission = description + demo + docs.
- Judging: creativity, technical complexity, practicality, presentation.
- Sleeper-fare reimbursement for non-Odisha teams. Meals provided.
...
- Fact-checking platform: React + Express + Python ML (LangDetect) + Firebase. Team photos in repo (anuska, arna, chandu).
...
3. ML/security depth.
4. README as pitch.
5. Scrappy code is fine; clean code is free points.

## 5. SPONSOR DNA (Google/Apple/FB/Accenture/Adobe)

| Company | Rewards | Stack signals |
|---|---|---|
| Google | practical AI, SDG alignment, working demos, Google tech (Gemini/Cloud/Android) | Android, Gemini, Cloud |
| Apple | Swift/SwiftUI skill, creativity, accessibility, polished UX | iOS, Swift |
| Meta | AI/LLM apps (Llama), social platforms, content moderation | Llama, React |
| Accenture | enterprise-grade, industry solutions, AI+cloud+data, business case, pitch | Cloud, data, AI |
| Adobe | creative tools, media tech, generative AI (Firefly), UI/UX | Creative Cloud APIs |

**Consensus**: AI/ML non-negotiable, working demo > deck, their platform usage = bonus, real-world impact framing, polish + presentation.

## 6. PARTICIPANT DATA (all editions)

| Listing | Edition | Registered | Players |
|---|---|---|---|
| 1171379 (national) | 2024 | 1318 | 280 |
| 1175823 (state RJ/AS/UP) | 2024 | 24 | 2 |
| 1545708 (Rajasthan) | 2025 | 706 | 147 |
| 1545546 (Punjab) | 2025 | 58 | 9 |
| 1561350 (Bihar) | 2025 | 15 | 1 |
| 1546080 (TN) | 2025 | 182 | 20 |
| 1730325 (UP) | 2026 | 1 | 0 (fresh) |

Full rosters: NOT published by organizers. Winners only. Counts = honest denominator.

## 7. WATCHDOG (live)

- Cron `craft-n-code-watch` (0437d80460ba): every 6h, probes Unstop for Rajasthan listing ID (probe range 1730320-1730340 + 1730400-1730420), judge reveals, reg count changes. Silent when nothing changes.
- Next run: 2026-08-14 02:34 IST.
...
- ❌ 2026 Rajasthan listing ID (watchdog hunting)
- ❌ 2026 judges (reveals come 1-2 days before)
- ❌ 2026 problem statements (sponsor companies, not released)
- ❌ 2024 brochure full text (image-based, OCR pending)
- ❌ Full participant rosters (never published)
- 🟡 Tech Society people dossiers (subagent in flight)
- 🟡 LinkedIn full profiles (auth-walled, snippet-level only)
